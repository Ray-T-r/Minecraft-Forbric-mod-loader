...
check "NeoForge RegisterEvent fired for content"  "fired RegisterEvent x[0-9]+ on [0-9]+ bus" "$LOG"
check "Forge RegisterEvent fired for content"     "fired Forge RegisterEvent x[0-9]+" "$LOG"
