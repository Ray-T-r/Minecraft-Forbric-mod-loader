...
| **The download crawls or times out** | github.com is slow where you are. Run it through a relay: `java -jar forbric-installer-0.1.0.jar --mirror https://your-relay.example/` |
